...
Route::get('/music/playlists/{playlist:slug}', [MusicController::class, 'playlist'])->name('music.playlists.show');
...
Route::get('/media/artworks/{artwork}/{variant}', [MediaController::class, 'artwork'])->whereIn('variant', ['master', 'original', 'display', 'thumb'])->name('media.artworks.show');
